      ...
      <footer className="bg-gray-700" aria-labelledby="footer-heading">
        ...
        <div className="m-auto max-w-2sm px-3 pb-8 pt-12 sm:pt-12 sm:px-8 lg:pt-12">
              ...
              <div className="flex space-x-6 ">
                {navigation.social.map((item) => (
                  <a key={item.name} href={item.href} className="text-gray-500 hover:text-gray-400 ">
                    ...
                    <item.icon className="h-6 w-6 l-6 " aria-hidden="true" />
                  </a>
                ))}
              </div>
            </div>
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-xs text-center leading-5 text-gray-400">&copy; 2023 Hotel Toni, Inc.. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
